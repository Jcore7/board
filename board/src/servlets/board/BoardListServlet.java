...
public class BoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		request.setAttribute("pageNavigator", new PageNavigator()
				.getPageNavigator(totalCount, boardModel.getListCount(),
		...
		RequestDispatcher requestDispatcher = request
				.getRequestDispatcher("/WEB-INF/jsps/board/boardList.jsp");
